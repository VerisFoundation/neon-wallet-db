...
VRS_MAINNET = ["http://seed{}.verisfoundation.com:10332".format(i) for i in [1,2,3,4]]

MAINNET_SEEDS = VRS_MAINNET # NEO_MAINNET + OTCGO_MAINNET + COZ_MAINNET
TESTNET_SEEDS = VRS_MAINNET # NEO_TESTNET + OTCGO_TESTNET + COZ_TESTNET
